...
// Categories
const categories = ["All", "Wedding", "Birthday", "BabyShower", "Concert"];
      ...
      >
        {filteredImages.map((img, index) => {
          ...
          return (
            <div
              key={index}
              className={`relative group bg-[#0B0B0B] border border-[#FFCB05]/10 rounded-xl overflow-hidden shadow-md transition-all duration-300 cursor-pointer ${
            ...
            >
              <img
                ...
                className={`w-full transition-all duration-300 ${
                  isExpanded ? "max-h-[80vh] object-contain" : "aspect-square object-cover"
                }`}
              />
              ...
              {isExpanded && (
                <button
                  ...
                  className="absolute top-3 left-3 bg-[#0B0B0Bdd] hover:bg-yellow-500 text-yellow-400 hover:text-black border border-yellow-400 hover:border-yellow-500 p-1.5 rounded-full transition-all duration-200"
                >
                  <X size={22} />
                </button>
              )}
