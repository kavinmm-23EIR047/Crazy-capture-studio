...
function App() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0c0c1d] via-[#111827] to-[#1a1a2e] text-white px-6">
      <div className="max-w-3xl text-center space-y-6">
        ...
        <p className="text-gray-300 text-lg">
          We’re currently working on improvements to give you a better experience.
          <br />
