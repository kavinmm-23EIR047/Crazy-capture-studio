...
function App() {
  ...
  className="fixed bottom-5 right-5 z-50 bg-yellow-500 hover:bg-yellow-600 text-black px-4 py-4 rounded-full shadow-xl transition-all duration-300 flex items-center group overflow-hidden"
>
  {/* Vibrating Call Icon */}
